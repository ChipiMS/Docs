		...
		},
		{
			...
			subtopics: [
				{	
					...
					body: '<div class="Code Console GET">https://sync.paybook.com/v1/catalogues/account_types</div><p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>fields</code> (opcional)</td><td>String</td><td>Select fields to be returned.</td></tr><tr><td><code>limit</code> (opcional)</td><td>Number</td><td>Limit the number of rows to be returned.</td></tr><tr><td><code>skip</code> (opcional)</td><td>Number</td><td>Skip rows to be returned.</td></tr><tr><td><code>order</code> (opcional)</td><td>String</td><td>Order the rows to be returned.</td></tr><tr><td><code>api_key</code></td><td>String</td><td>Developer key.</td></tr><tr><td><code>id_user</code></td><td>String</td><td>User ID.</td></tr><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table><p><b>Success 200</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>id_account_type</code></td><td>String</td><td>Account type ID.</td></tr><tr><td><code>name</code></td><td>String</td><td>Account type name.</td></tr></tbody></table><p><b>Success-Response:</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_account_type: <span class="Green">"520d3aa93b8e778e0d003412"</span>,</div><div>name: <span class="Green">"Account Type 1"</span></div></div><div>],</div><div>[</div><div class="Identation"><div>id_account_type: <span class="Green">"520d3aa93b8e778e0d003417"</span>,</div><div>name: <span class="Green">"Account Type 2"</span></div></div><div>]</div></div><div>]</div></div><div>]</div></div>',
				},
				{	
					title: "Request attachment types",
					body: '<div class="Code Console GET">https://sync.paybook.com/v1/catalogues/attachment_types</div><p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>fields</code> (opcional)</td><td>String</td><td>Select fields to be returned.</td></tr><tr><td><code>limit</code> (opcional)</td><td>Number</td><td>Limit the number of rows to be returned.</td></tr><tr><td><code>skip</code> (opcional)</td><td>Number</td><td>Skip rows to be returned.</td></tr><tr><td><code>order</code> (opcional)</td><td>String</td><td>Order the rows to be returned.</td></tr><tr><td><code>api_key</code></td><td>String</td><td>Developer key.</td></tr><tr><td><code>id_user</code></td><td>String</td><td>User ID.</td></tr><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table><p><b>Success 200</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>_id</code></td><td>String</td><td>Attachment type ID.</td></tr><tr><td><code>name</code></td><td>String</td><td>Attachment type name.</td></tr></tbody></table><p><b>Success-Response:</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_attachment_type: <span class="Green">"56bcdfca784806d1378b1234"</span>,</div><div>name: <span class="Green">"Type 1"</span></div></div><div>],</div><div>[</div><div class="Identation"><div>id_attachment_type: <span class="Green">"56bcdfca784806d1378b4321"</span>,</div><div>name: <span class="Green">"Type 2"</span></div></div><div>]</div></div><div>]</div></div><div>]</div></div>',
				},
				{	
					title: "Request available countries",
					body: '<div class="Code Console GET">https://sync.paybook.com/v1/catalogues/countries</div><p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>fields</code> (opcional)</td><td>String</td><td>Select fields to be returned.</td></tr><tr><td><code>limit</code> (opcional)</td><td>Number</td><td>Limit the number of rows to be returned.</td></tr><tr><td><code>skip</code> (opcional)</td><td>Number</td><td>Skip rows to be returned.</td></tr><tr><td><code>order</code> (opcional)</td><td>String</td><td>Order the rows to be returned.</td></tr><tr><td><code>api_key</code></td><td>String</td><td>Developer key.</td></tr><tr><td><code>id_user</code></td><td>String</td><td>User ID.</td></tr><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table><p><b>Success 200</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>id_country</code></td><td>String</td><td>Country ID.</td></tr><tr><td><code>name</code></td><td>String</td><td>Country name.</td></tr><tr><td><code>code</code></td><td>String</td><td>Country code.</td></tr></tbody></table><p><b>Success-Response:</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_country: <span class="Green">"56bcdfca784806d1378b1234"</span>,</div><div>name: <span class="Green">"United States"</span>,</div><div>code: <span class="Green">"US"</span></div></div><div>],</div><div>[</div><div class="Identation"><div>id_country: <span class="Green">"56bcdfca784806d1378b1239"</span>,</div><div>name: <span class="Green">"Mexico"</span>,</div><div>code: <span class="Green">"MX"</span></div></div><div>]</div></div><div>]</div></div><div>]</div></div>',
				},
				{	
					title: "Request available sites",
					body: '<div class="Code Console GET">https://sync.paybook.com/v1/catalogues/sites</div><p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>id_site</code> (opcional)</td><td>String</td><td>Site ID.</td></tr><tr><td><code>id_site_organization</code> (opcional)</td><td>String</td><td>Site Organization ID.</td></tr><tr><td><code>id_site_organization_type</code> (opcional)</td><td>String</td><td>Site Organization Type ID.</td></tr><tr><td><code>fields</code> (opcional)</td><td>String</td><td>Select fields to be returned.</td></tr><tr><td><code>limit</code> (opcional)</td><td>Number</td><td>Limit the number of rows to be returned.</td></tr><tr><td><code>skip</code> (opcional)</td><td>Number</td><td>Skip rows to be returned.</td></tr><tr><td><code>order</code> (opcional)</td><td>String</td><td>Order the rows to be returned.</td></tr><tr><td><code>api_key</code></td><td>String</td><td>Developer key.</td></tr><tr><td><code>id_user</code></td><td>String</td><td>User ID.</td></tr><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table><p><b>Success 200</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>id_site</code></td><td>String</td><td>Site ID.</td></tr><tr><td><code>id_site_organization</code></td><td>String</td><td>Site Organization ID.</td></tr><tr><td><code>id_site_organization_type</code></td><td>String</td><td>Site Organization Type ID.</td></tr><tr><td><code>name</code></td><td>String</td><td>Site name.</td></tr><tr><td><code>credentials</code></td><td>Collection</td><td>[name: Field name, type : Input render type, label : Label, required : Indicates if field is required, username : Indicates if field is username, validation : Validate field]</td></tr></tbody></table><p><b>Success-Response</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_site: <span class="Green">"56de2130784806d7028b4589"</span>,</div><div>id_site_organization: <span class="Green">"56bcdfca784806d173611234"</span>,</div><div>id_site_organization_type: <span class="Green">"56bcdfca846106d1378b9182"</span>,</div><div>name: <span class="Green">"Site Name"</span>,</div><div>credentials: [</div><div class="Identation"><div><span class="LightBlue">0</span>: [</div><div class="Identation"><div>name: <span class="Green">"credential1"</span>,</div><div>type: <span class="Green">"text"</span>,</div><div>label: <span class="Green">"Credential"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">true</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>],</div><div>1: [</div><div class="Identation"><div>name: <span class="Green">"credential2"</span>,</div><div>type: <span class="Green">"password"</span>,</div><div>label: <span class="Green">"pass"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">false</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>]</div></div><div>]</div></div><div>],</div><div>[</div><div class="Identation"><div>id_site: <span class="Green">"56de2130784806d7028b4581"</span>,</div><div>id_site_organization: <span class="Green">"56bcdfca784806d173611232"</span>,</div><div>id_site_organization_type: <span class="Green">"56bcdfca846106d1378b9183"</span>,</div><div>name: <span class="Green">"Other Site Name"</span>,</div><div>credentials: [</div><div class="Identation"><div><span class="LightBlue">0</span>: [</div><div class="Identation"><div>name: <span class="Green">"credential1"</span>,</div><div>type: <span class="Green">"text"</span>,</div><div>label: <span class="Green">"Credential"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">true</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>],</div><div>1: [</div><div class="Identation"><div>name: <span class="Green">"credential2"</span>,</div><div>type: <span class="Green">"password"</span>,</div><div>label: <span class="Green">"pass"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">false</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>]</div></div><div>]</div></div><div>],</div></div><div>]</div></div><div>]</div></div>',
				},
				{	
					title: "Request site organizations",
					body: '<div class="Code Console GET">https://sync.paybook.com/v1/catalogues/site_organizations</div><p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>id_site_organization</code> (opcional)</td><td>String</td><td>Site Organization ID.</td></tr><tr><td><code>id_site_organization_type</code> (opcional)</td><td>String</td><td>Site Organization Type ID.</td></tr><tr><td><code>id_country</code> (opcional)</td><td>String</td><td>Country ID.</td></tr><tr><td><code>fields</code> (opcional)</td><td>String</td><td>Select fields to be returned.</td></tr><tr><td><code>limit</code> (opcional)</td><td>Number</td><td>Limit the number of rows to be returned.</td></tr><tr><td><code>skip</code> (opcional)</td><td>Number</td><td>Skip rows to be returned.</td></tr><tr><td><code>order</code> (opcional)</td><td>String</td><td>Order the rows to be returned.</td></tr><tr><td><code>api_key</code></td><td>String</td><td>Developer key.</td></tr><tr><td><code>id_user</code></td><td>String</td><td>User ID.</td></tr><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table><p><b>Success 200</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>id_site_organization</code></td><td>String</td><td>Site Organization ID.</td></tr><tr><td><code>id_site_organization_type</code></td><td>String</td><td>Site Organization Type ID.</td></tr><tr><td><code>id_country</code></td><td>String</td><td>Country ID.</td><tr><td><code>name</code></td><td>String</td><td>Organization name.</td></tr><tr><td><code>avatar</code></td><td>String</td><td>Avatar logo.</td></tr><tr><td><code>small_cover</code></td><td>String</td><td>Small cover.</td></tr><tr><td><code>cover</code></td><td>String</td><td>Cover logo.</td></tr></tbody></table><p><b>Success-Response:</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_site: <span class="Green">"56de2130784806d7028b4589"</span>,</div><div>id_site_organization: <span class="Green">"56bcdfca784806d173611234"</span>,</div><div>id_site_organization_type: <span class="Green">"56bcdfca846106d1378b9182"</span>,</div><div>name: <span class="Green">"Site Name"</span>,</div><div>credentials: [</div><div class="Identation"><div><span class="LightBlue">0</span>: [</div><div class="Identation"><div>name: <span class="Green">"credential1"</span>,</div><div>type: <span class="Green">"text"</span>,</div><div>label: <span class="Green">"Credential"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">true</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>],</div><div>1: [</div><div class="Identation"><div>name: <span class="Green">"credential2"</span>,</div><div>type: <span class="Green">"password"</span>,</div><div>label: <span class="Green">"pass"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">false</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>]</div></div><div>]</div></div><div>],</div><div>[</div><div class="Identation"><div>id_site: <span class="Green">"56de2130784806d7028b4581"</span>,</div><div>id_site_organization: <span class="Green">"56bcdfca784806d173611232"</span>,</div><div>id_site_organization_type: <span class="Green">"56bcdfca846106d1378b9183"</span>,</div><div>name: <span class="Green">"Other Site Name"</span>,</div><div>credentials: [</div><div class="Identation"><div><span class="LightBlue">0</span>: [</div><div class="Identation"><div>name: <span class="Green">"credential1"</span>,</div><div>type: <span class="Green">"text"</span>,</div><div>label: <span class="Green">"Credential"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">true</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>],</div><div>1: [</div><div class="Identation"><div>name: <span class="Green">"credential2"</span>,</div><div>type: <span class="Green">"password"</span>,</div><div>label: <span class="Green">"pass"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">false</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>]</div></div><div>]</div></div><div>],</div></div><div>]</div></div><div>]</div></div>',
				},
				{	
					title: "",
					body: '<p></p>',
