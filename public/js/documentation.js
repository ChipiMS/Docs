		...
		},
		{
			...
			subtopics: [
				...
				},
				{
					...
					blue: '<p><b>Get</b></p><div class="Code Console GET">https://sync.paybook.com/v1/attachments/:id_attachment</div>',
				},
				{
				...
				},
				{
					...
					blue: '<p><b>Get</b></p><div class="Code Console GET">https://sync.paybook.com/v1/attachments/counts</div><p><b>Success-Response:</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation">count: <span class="LightBlue">3946</span></div><div>]</div></div>',
				}
			]
		},
		{
			...
			subtopics: [
				...
				},
				{
					...
					blue: '<p><b>Get</b></p><div class="Code Console">https://sync.paybook.com/v1/catalogues/organizations/sites</div><p><b>Success-Response:</b></p><div class="Code JS"><div>HTTP/<span class="LightBlue">1.1 200</span> OK</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_site_organization: <span class="Green">"56bcdfca784806d173611234"</span>,</div><div>id_site_organization_type: <span class="Green">"56bcdfca846106d1378b9182"</span>,</div><div>is_disable: <span class="LightBlue">0</span>,</div><div>[</div><div class="Identation"><div>[</div><div class="Identation"><div>id_site: <span class="Green">"56de2130784806d7028b4589"</span>,</div><div>name: <span class="Green">"Site Name"</span>,</div><div>credentials: [</div><div class="Identation"><div><span class="LightBlue">0</span>: [</div><div class="Identation"><div>name: <span class="Green">"credential1"</span>,</div><div>type: <span class="Green">"text"</span>,</div><div>label: <span class="Green">"Credential"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">true</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>],</div><div><span class="LightBlue">1</span>: [</div><div class="Identation"><div>name: <span class="Green">"credential2"</span>,</div><div>type: <span class="Green">"password"</span>,</div><div>label: <span class="Green">"pass"</span>,</div><div>required: <span class="Yellow">true</span>,</div><div>username: <span class="Yellow">false</span>,</div><div>validation: <span class="Yellow">null</span></div></div><div>]</div></div><div>]</div></div><div>]</div></div><div>]</div></div><div>]</div></div><div>]</div></div><div>]</div></div>',
				}
			]
		},
		{
			...
			subtopics: [
				{
					...
					body: '<p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>api_key</code></td><td>String</td><td>Developer key.</td></tr><tr><td><code>id_user</code></td><td>String</td><td>User ID.</td></tr><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table>',
					blue: '<p><b>Delete</b></p><div class="Code Console">https://sync.paybook.com/v1/credentials/:id_credential</div>',
				},
				{
					...
					blue: '<p><b>Delete</b></p><div class="Code Console">https://sync.paybook.com/v1/credentials</div><p><b>Success-Response:</b></p>',
				},
				{
					...
					blue: '<p><b>Post</b></p><div class="Code Console">https://sync.paybook.com/v1/credentials</div>',
				}
			]
		},
		{
			...
			subtopics: [
				{
					...
					blue: '<p><b>Post</b></p><div class="Code Console">https://sync.paybook.com/v1/sessions</div>',
				},
				{
					...
					blue: '<p><b>Delete</b></p><div class="Code Console">https://sync.paybook.com/v1/sessions/:token</div>',
				},
				{
					title: "Validates session token",
					body: '<p><b>Parámetro</b></p><table><thead><tr><th>Campo</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>token</code></td><td>String</td><td>Session Token.</td></tr></tbody></table>',
					blue: '<p><b>Get</b></p><div class="Code Console">https://sync.paybook.com/v1/sessions/:token/verify</div>',
				}
			]
		},
		{
			...
			subtopics: [
				{
					...
					blue: '<p><b>Get</b></p><div class="Code Console">https://sync.paybook.com/v1/transactions/count</div>',
				},
				{
					...
					blue: '<p><b>Get</b></p><div class="Code Console">https://sync.paybook.com/v1/transactions</div>',
				}
			]
		},
		{
			...
			subtopics: [
				{
					...
					blue: '<p><b>Post</b></p><div class="Code Console">https://sync.paybook.com/v1/users</div>',
				},
				{
					...
					blue: '<p><b>Delete</b></p><div class="Code Console">https://sync.paybook.com/v1/users/:id_user</div>',
				},
				{
					...
					blue: '<p><b>Get</b></p><div class="Code Console">https://sync.paybook.com/v1/users</div>',
				}
			]
		},
		{
